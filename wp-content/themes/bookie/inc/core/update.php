...
function toko_theme_updater_menu() {
    add_theme_page( esc_html__( 'Theme Update', 'bookie-wp' ), esc_html__( 'Theme Update', 'bookie-wp' ), 'manage_options', 'theme-updater', 'toko_theme_updater_page' );
}
...
function toko_theme_updater_page() {
    ...
    ?>
    <div class="wrap">
        <h2><?php esc_html_e('Theme Update Options', 'bookie-wp'); ?></h2>
                ...
                <tbody>
                    <tr valign="top">
                        <th scope="row" valign="top">
                            <?php esc_html_e('License Key', 'bookie-wp'); ?>
                        </th>
                        <td>
                            <input id="theme_license_key" name="theme_license_key" type="text" class="regular-text" value="<?php echo esc_attr( $license ); ?>" />
                            <label class="description" for="theme_license_key"><?php esc_html_e('Enter your license key', 'bookie-wp'); ?></label>
                        </td>
                    </tr>
                </tbody>
            </table>

            <p><?php esc_html_e( 'Note: If you purchase this theme from ThemeForest, License Key is your Purchase Code.', 'bookie-wp' ); ?></p>
...
class TOKO_Theme_Updater {
    ...
    function update_nag() {
        ...
        $update_onclick = ' onclick="if ( confirm(\'' . esc_js( esc_html__( "Updating this parent theme will lose any customizations you have made. Please consider using child theme for modifications. 'Cancel' to stop, 'OK' to update.", 'bookie-wp' ) ) . '\') ) {return true;}return false;"';
