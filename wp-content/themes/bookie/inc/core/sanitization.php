 ...
 */
function toko_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function toko_sanitize_css( $css ) {
 ...
 */
function toko_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function toko_sanitize_email( $email, $setting ) {
 ...
 */
function toko_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function toko_sanitize_html( $html ) {
 ...
 */
function toko_sanitize_image( $image, $setting ) {
 ...
 */
function toko_sanitize_nohtml( $nohtml ) {
 ...
 */
function toko_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function toko_sanitize_number_range( $number, $setting ) {
 ...
 */
function toko_sanitize_select( $input, $setting ) {
 ...
 */
function toko_sanitize_url( $url ) {
